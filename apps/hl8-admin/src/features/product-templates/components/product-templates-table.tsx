...
import { productTemplatesColumns as columns } from './product-templates-columns'
...
export function ProductTemplatesTable({
  ...
  // Synced with URL states (keys/defaults mirror product-templates route search schema)
  const {
    columnFilters,
