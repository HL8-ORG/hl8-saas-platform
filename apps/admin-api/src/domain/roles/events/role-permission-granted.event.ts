 ...
 * - 记录审计日志
 *
 * @class RolePermissionGrantedEvent
 * @extends {DomainEventBase}
 * @description 角色权限已授予领域事件
 */
export class RolePermissionGrantedEvent extends DomainEventBase {
  /**
   * 角色名称
   *
   * 被授予权限的角色名称。
  ...
  constructor(
    ...
    super(roleId, 'RolePermissionGrantedEvent', tenantId.toString());
